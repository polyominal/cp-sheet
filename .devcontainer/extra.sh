...
# Choose between amd64 mirror or arm64 mirror
if [ "${ARCHITECTURE}" = "amd64" ]; then
    sudo cp ./.devcontainer/sources.list.amd64 /etc/apt/sources.list
else
    sudo cp ./.devcontainer/sources.list.arm64 /etc/apt/sources.list
fi
